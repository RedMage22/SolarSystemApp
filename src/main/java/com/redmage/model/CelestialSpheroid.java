...
public class CelestialSpheroid extends Sphere {
    ...
    public CelestialSpheroid(String name, double radiusFactor, double largestRadiusInKm, double zDistanceFactor,
                             double farthestZDistanceInKm, PhongMaterial material, double rotationTimeFactor,
                             double slowestRotationTimeInHours, boolean isRotationClockwise, double orbitTimeFactor, double slowestOrbitTimeInDays) {
        this.name = name;
        this.setRadius(radiusFactor * largestRadiusInKm);
        distanceInKm =  largestRadiusInKm + (zDistanceFactor * farthestZDistanceInKm) + this.getRadius();
